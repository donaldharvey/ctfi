...
from spixel.algorithm import PWLWorstFirst, WorstBlockFirst
...
if __name__ == '__main__':
    ...
    f = '/me/w/proj/slic/SLIC-Superpixels/BSDS500/130066.jpg'
    ...
    e = Engine(imread(f), PWLWorstFirst, {'number_superpixels': 100, 'max_pixel_size': 16})
    e.run()
    e.draw_boundaries()
